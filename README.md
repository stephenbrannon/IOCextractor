...
The program is written in Python 3, and a binary version for Windows is provided (IOCextractor.zip). A simple demonstration case report (DemonstrationCaseReport.txt) and a testing file (TestDocument.txt) are also provided. 
